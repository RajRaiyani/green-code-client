...
function RegisterUser(){
    ...
    return(
        <div className="absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 border rounded-xl px-5 py-3 max-w-[370px] w-[90vw] gc-shadow-9">
            ...
            <h1 className="text-center text-lg mt-2">Sign In</h1>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col">
                ...
                <input type="submit" value="Sign In" className="gc-bg-green text-white rounded-lg p-1 mt-2 cursor-pointer" />
            </form>
            <p className="text-center font-light text-sm mt-2">Already have an account ? <Link to={"/login"} className="gc-text-green font-bold">Log In</Link></p>
        </div>
    )
}
